...
function normalizeStateV1(parsed: unknown): OrchestrationState {
  ...
  return {
    ...
    privateValidationFeedbackCount: readOptionalSafeInteger(state, 'privateValidationFeedbackCount') ?? 0,
    privateValidationFeedbackPath: readOptionalNullableString(state, 'privateValidationFeedbackPath') ?? null,
